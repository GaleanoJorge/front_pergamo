...
@Component({
  selector: 'ngx-form-instance-admission',
  templateUrl: './form-instance-admission.component.html',
  styleUrls: ['./form-instance-admission.component.scss'],
})
export class FormInstanceAdmissionComponent implements OnInit {
  @Input() title: string;
  @Input() data: any = null;
  @Input() user: any = null;
