...
@Component({
  selector: 'ngx-form-pah-applications',
  templateUrl: './form-pah-applications.component.html',
  styleUrls: ['./form-pah-applications.component.scss'],
})
export class FormPahApplicationsComponent implements OnInit {
  @Input() title: string;
  @Input() data: any = null;
