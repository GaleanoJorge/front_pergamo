...
@Component({
  selector: 'ngx-form-interconsultation',
  templateUrl: './form-interconsultation.component.html',
  styleUrls: ['./form-interconsultation.component.scss'],
})
export class FormInterconsultationComponent implements OnInit {
  @Input() title: string;
  @Input() data: any = null;
  @Input() user: any = null;
