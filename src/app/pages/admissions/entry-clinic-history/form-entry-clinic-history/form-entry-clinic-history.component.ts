...
@Component({
  selector: 'ngx-form-entry-clinic-history',
  templateUrl: './form-entry-clinic-history.component.html',
  styleUrls: ['./form-entry-clinic-history.component.scss']
})
export class FormEntryClinicHistoryComponent implements OnInit {
