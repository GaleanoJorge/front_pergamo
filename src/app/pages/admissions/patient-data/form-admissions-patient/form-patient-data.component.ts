...
export class FormPatientDataComponent implements OnInit {
  ...
  save() {
    this.residence =
      this.form.controls.residence_address.value +
      ' ' +
      ...
      ', ' +
      this.form.controls.residence_address_cardinality.value +
      ' ' +
      ' ( ' +
    ...
    if (!this.form.invalid) {
      ...
      if (this.data.id) {
        this.PatientDataS.Update({
          ...
          identification_type_id:
            this.form.controls.identification_type_id.value,
