...
@Component({
  selector: 'ngx-activities-pending-assignment-trainer',
  templateUrl: './activities-pending-assignment-trainer.component.html',
  styleUrls: ['./activities-pending-assignment-trainer.component.scss']
})
export class ActivitiesPendingAssignmentTrainerComponent implements OnInit {

  public messageError = null;
  public title = 'Reporte de actividades pendientes por asignar formador';
  public exportExcelSGA = 'activitiesPendingAssignmentTrainer';
  public validateData = () => {
