...
@Component({
  selector: 'ngx-attendees-all-courses',
  templateUrl: './attendees-all-courses.component.html',
  styleUrls: ['./attendees-all-courses.component.scss']
})
export class AttendeesAllCoursesComponent implements OnInit {
  public messageError = null;
  public title = 'Discentes asistentes de todos los cursos registrados';
  public exportExcelSGA = 'attendeesOfAllCourses';
  public validateData = () => {
