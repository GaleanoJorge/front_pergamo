...
@Component({
  selector: 'ngx-assigned-trainers',
  templateUrl: './assigned-trainers.component.html',
  styleUrls: ['./assigned-trainers.component.scss']
})
export class AssignedTrainersComponent implements OnInit {

  public messageError = null;
  public title = 'Listado de formadores asignados en actividades académicas';
  public exportExcelSGA = 'assignedTrainers';
  public validateData = () => {
