...
@Component({
  selector: 'ngx-form-pharmacy-request-patient',
  templateUrl: './form-pharmacy-request-patient.component.html',
  styleUrls: ['./form-pharmacy-request-patient.component.scss']
})
export class FormPharmacyRequestPatientComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    } else if (this.data.product_supplies_id != null) {
