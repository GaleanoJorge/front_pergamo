...
@Component({
  selector: 'ngx-income-supplies-package',
  templateUrl: './income-supplies-package.component.html',
  styleUrls: ['./income-supplies-package.component.scss'],
})
export class IncomeSuppliesPackageComponent implements OnInit {
  ...
  public settings_supplies = {
    columns: {
      select: {
        ...
        renderComponent: SelectSuppliesIncomeComponent,
      },
      ...
      amount: {
        ...
        renderComponent: AmountSupComeComponent,
      },
      ...
      amount_damaged: {
        ...
        renderComponent: AmountDamagedSupComponent,
      },
    },
  };
