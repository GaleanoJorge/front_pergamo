...
@Component({
  selector: 'ngx-form-human-talent-request',
  templateUrl: './form-human-talent-request.component.html',
  styleUrls: ['./form-human-talent-request.component.scss'],
})
export class FormHumanTalentRequestComponent implements OnInit {
  @Input() title: string;
  @Input() data: any = null;
  ...
  constructor(
    ...
    private accountReceivableS: HumanTalentRequestService,
