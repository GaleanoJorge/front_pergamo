...
@Component({
  selector: 'ngx-form-show-billing-pgp',
  templateUrl: './form-show-billing-pgp.component.html',
  styleUrls: ['./form-show-billing-pgp.component.scss']
})
export class FormShowBillingPgpComponent implements OnInit {
