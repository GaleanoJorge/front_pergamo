...
@Component({
  template: `
    <div class="d-flex justify-content-center">
      <a ngxCheckPerms="update" nbButton ghost [routerLink]="'../../teacher/teachers/' + value.data.id+ '/edit'">
      ...
      <a nbButton nbButton ghost [routerLink]="'../../teacher/teachers/history-teacher/' + value.data.id" title="Historial Usuario">
