...
@Component({
  selector: 'ngx-form-muscular-strength-ft',
  templateUrl: './form-muscular-strength-ft.component.html',
  styleUrls: ['./form-muscular-strength-ft.component.scss']
})
export class FormMuscularStrengthFTComponent implements OnInit {
    ...
    if (!this.form.invalid) {
      ...
      this.showTable = false;
       if (this.data.id) {
          ...
          this.ChEMuscularStrengthFTService.Save({
            head: this.form.controls.head.value,
            sup_left: this.form.controls.sup_left.value,
            hand_left: this.form.controls.hand_left.value,
            sup_right: this.form.controls.sup_right.value,
