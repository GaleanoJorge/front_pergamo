...
@Component({
  selector: 'ngx-form-muscular-tone-ft',
  templateUrl: './form-muscular-tone-ft.component.html',
  styleUrls: ['./form-muscular-tone-ft.component.scss']
})
export class FormMuscularToneFTComponent implements OnInit {
    ...
    if (!this.form.invalid) {
      ...
      this.showTable = false;
       if (this.data.id) {
          ...
          this.ChEMuscularToneFTService.Save({
            head: this.form.controls.head.value,
            sup_left: this.form.controls.sup_left.value,
            hand_left: this.form.controls.hand_left.value,
            sup_right: this.form.controls.sup_right.value,
