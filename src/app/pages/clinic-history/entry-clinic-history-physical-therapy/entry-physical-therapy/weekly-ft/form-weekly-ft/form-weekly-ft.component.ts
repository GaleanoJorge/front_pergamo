...
@Component({
  selector: 'ngx-form-weekly-ft',
  templateUrl: './form-weekly-ft.component.html',
  styleUrls: ['./form-weekly-ft.component.scss']
})
export class FormWeeklyFTComponent implements OnInit {
