...
@Component({
  selector: 'ngx-form-nr-diagnosis-ft',
  templateUrl: './form-nr-diagnosis-ft.component.html',
  styleUrls: ['./form-nr-diagnosis-ft.component.scss']
})
export class FormNRDiagnosisFTComponent implements OnInit {
