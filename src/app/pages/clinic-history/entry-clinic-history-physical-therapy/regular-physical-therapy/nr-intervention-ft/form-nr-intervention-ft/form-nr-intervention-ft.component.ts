...
@Component({
  selector: 'ngx-form-nr-intervention-ft',
  templateUrl: './form-nr-intervention-ft.component.html',
  styleUrls: ['./form-nr-intervention-ft.component.scss']
})
export class FormNRinterventionFTComponent implements OnInit {
