...
@Component({
  selector: 'ngx-form-nr-ther-goals-ft',
  templateUrl: './form-nr-ther-goals-ft.component.html',
  styleUrls: ['./form-nr-ther-goals-ft.component.scss']
})
export class FormRNTherGoalsFTComponent implements OnInit {
