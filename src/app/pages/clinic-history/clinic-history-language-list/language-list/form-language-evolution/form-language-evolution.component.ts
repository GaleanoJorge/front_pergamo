...
export class FormLanguageEvolutionComponent implements OnInit {
  ...
  goto($event) {
    ...
    if (selectedAccordion == 'Ostomias') {
      this.show[1] = true;
    } else if (selectedAccordion =='Alteraciones En La Deglución') {
      this.show[2] = true;
    }
    else if (selectedAccordion == 'Alteraciones En La Voz') {
      this.show[3] = true;
    }
    else if (selectedAccordion == 'Audición') {
      this.show[4] = true;
    }
    else if (selectedAccordion == 'Lenguaje') {
      this.show[5] = true;
    }
    else if (selectedAccordion == 'Comunicación') {
      this.show[6] = true;
    }
    else if (selectedAccordion == 'Cognitivo') {
      this.show[7] = true;
    }
    else if (selectedAccordion == 'Orofacial') {
      this.show[8] = true;
    }
    else if (selectedAccordion == 'Habla') {
      this.show[9] = true;
    }
    else if (selectedAccordion == 'Pruebas Especificas') {
      this.show[10] = true;
    }
    else if (selectedAccordion == 'Objetivos Terapeuticos') {
      this.show[11] = true;
    }
    else if (selectedAccordion == 'Diagnostico Cif') {
      this.show[12] = true;
    }
    else if (selectedAccordion == 'Numero de Sesiones Mensuales E Intensidad Semana') {
      this.show[13] = true;
    }
}
}