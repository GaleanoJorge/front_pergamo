...
export class RegularLanguageListComponent implements OnInit {
  ...
  goto($event) {
    ...
    if (selectedStep == '2' || selectedStep == 'Signos Vitales') {
      this.show1 = true;
    } else if (selectedStep == '3' || selectedStep == 'Obj Terapeuticos') {
      this.show2 = true;
    } else if (selectedStep == '4' || selectedStep == 'Intervención') {
      this.show3 = true;
    }
    else if (selectedStep == '5' || selectedStep == 'Materiales E Insumos') {
      this.show4 = true;
    }
    else if (selectedStep == '6' || selectedStep == 'Conceptos de Fonoaudiologia') {
      this.show5 = true;
    }
    else if (selectedStep == '7' || selectedStep == 'Diagnostico') {
      this.show6 = true;
    }
