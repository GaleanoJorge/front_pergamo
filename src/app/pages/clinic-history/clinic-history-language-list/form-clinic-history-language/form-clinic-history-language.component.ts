...
@Component({
  selector: 'ngx-form-clinic-history-language',
  templateUrl: './form-clinic-history-language.component.html',
  styleUrls: ['./form-clinic-history-language.component.scss']
})
export class FormClinicHistoryLanguageComponent implements OnInit {
