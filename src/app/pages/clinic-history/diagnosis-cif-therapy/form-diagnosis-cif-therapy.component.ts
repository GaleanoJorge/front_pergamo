...
@Component({
  selector: 'ngx-form-diagnosis-cif-therapy',
  templateUrl: './form-diagnosis-cif-therapy.component.html',
  styleUrls: ['./form-diagnosis-cif-therapy.component.scss']
})
export class FormDiagnosisCifTherapyComponent implements OnInit {
