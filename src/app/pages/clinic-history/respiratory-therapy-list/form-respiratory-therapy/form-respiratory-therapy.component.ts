...
@Component({
  selector: 'ngx-form-respiratory-therapy',
  templateUrl: './form-respiratory-therapy.component.html',
  styleUrls: ['./form-respiratory-therapy.component.scss']
})
export class FormRespiratoryTherapyComponent implements OnInit {
