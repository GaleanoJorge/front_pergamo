...
@Component({
  selector: 'ngx-form-reason-consultation-rt',
  templateUrl: './form-reason-consultation-rt.component.html',
  styleUrls: ['./form-reason-consultation-rt.component.scss']
})
export class FormReasonConsultationRTComponent implements OnInit {
