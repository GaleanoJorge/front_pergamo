...
@Component({
  selector: 'ngx-form-ispection',
  templateUrl: './form-ispection.component.html',
  styleUrls: ['./form-ispection.component.scss']
})
export class FormIspectionComponent implements OnInit {
