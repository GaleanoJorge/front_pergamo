...
@Component({
  selector: 'ngx-ch-scale-ppi',
  templateUrl: './ch-scale-ppi.component.html',
  styleUrls: ['./ch-scale-ppi.component.scss'],
})
export class ChScalePpiComponent implements OnInit {
  @ViewChild(BaseTableComponent) table: BaseTableComponent;
  @Input() refresh18;

  linearMode = true;
  public messageError = null;
  public title: string = 'Registros Escala PPI';
  ...
  ngOnChanges(changes: SimpleChanges) {
    if(changes.refresh18.currentValue==true){
      this.RefreshData();
    }
