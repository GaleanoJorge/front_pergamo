...
@Component({
  selector: 'ngx-ch-scale-zarit',
  templateUrl: './ch-scale-zarit.component.html',
  styleUrls: ['./ch-scale-zarit.component.scss'],
})
export class ChScaleZaritComponent implements OnInit {
  @ViewChild(BaseTableComponent) table: BaseTableComponent;
  @Input() refresh19;

  linearMode = true;
  public messageError = null;
  public title: string = 'Registros Escala Zarit';
  ...
  ngOnChanges(changes: SimpleChanges) {
    if(changes.refresh19.currentValue==true){
      this.RefreshData();
    }
