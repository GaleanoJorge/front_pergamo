...
@Component({
  selector: 'ngx-form-entry-valoration-consultation-occupational-therapy',
  templateUrl: './form-entry-valoration-consultation-occupational-therapy.component.html',
  styleUrls: ['./form-entry-valoration-consultation-occupational-therapy.component.scss']
})
export class FormEntryValorationConsultationOccupationalTherapyComponent implements OnInit {
