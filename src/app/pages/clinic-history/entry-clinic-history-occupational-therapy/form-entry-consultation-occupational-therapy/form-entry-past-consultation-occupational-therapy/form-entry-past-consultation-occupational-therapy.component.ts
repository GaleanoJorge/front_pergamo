...
@Component({
  selector: 'ngx-form-entry-past-consultation-occupational-therapy',
  templateUrl: './form-entry-past-consultation-occupational-therapy.component.html',
  styleUrls: ['./form-entry-past-consultation-occupational-therapy.component.scss']
})
export class FormEntryPastConsultationOccupationalTherapyComponent implements OnInit {
