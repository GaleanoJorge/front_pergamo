...
@Component({
  selector: 'ngx-form-regular-note-consultation-occupational-therapy',
  templateUrl: './form-regular-note-consultation-occupational-therapy.component.html',
  styleUrls: ['./form-regular-note-consultation-occupational-therapy.component.scss']
})
export class FormRegularNoteConsultationOccupationalTherapyComponent implements OnInit {
