...
@Component({
  selector: 'ngx-form-regular-note-occupational-therapy',
  templateUrl: './form-regular-note-occupational-therapy.component.html',
  styleUrls: ['./form-regular-note-occupational-therapy.component.scss']
})
export class FormRegularNoteOccupationalTherapyComponent implements OnInit {
