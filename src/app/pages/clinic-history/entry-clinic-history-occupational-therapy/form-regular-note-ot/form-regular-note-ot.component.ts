...
@Component({
  selector: 'ngx-form-regular-note-ot',
  templateUrl: './form-regular-note-ot.component.html',
  styleUrls: ['./form-regular-note-ot.component.scss']
})
export class FormRegularNoteOTComponent implements OnInit {
