...
@Component({
  selector: 'ngx-form-regular-note-valoration-ot',
  templateUrl: './form-regular-note-valoration-ot.component.html',
  styleUrls: ['./form-regular-note-valoration-ot.component.scss']
})
