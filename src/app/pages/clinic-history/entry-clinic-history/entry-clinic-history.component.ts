...
export class EntryClinicHistoryComponent implements OnInit {
  ...
  goto($event) {
    ...
    if (selectedStep == '2' || selectedStep == 'Rx Sistemas') {
      this.show1 = true;
    } else if (selectedStep == '3' || selectedStep == 'Antecedentes') {
      this.show2 = true;
    } else if (selectedStep == '4' || selectedStep == 'Ex Físico') {
      this.show3 = true;
    }
    else if (selectedStep == '5' || selectedStep == 'Signos Vitales') {
      this.show4 = true;
    }
    else if (selectedStep == '6' || selectedStep == 'Diagnóstico') {
      this.show5 = true;
    }
    else if (selectedStep == '7' || selectedStep == 'Ostomías') {
      this.show6 = true;
    }
    else if (selectedStep == '8' || selectedStep == 'AP') {
      this.show7 = true;
    }
    else if (selectedStep == '9' || selectedStep == 'Recomendaciones') {
      this.show8 = true;
    }
    else if (selectedStep == '10' || selectedStep == 'Dietas') {
      this.show9= true;
    }
  }
}
