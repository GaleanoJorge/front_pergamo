...
@Component({
  selector: 'ngx-form-regular-respiratory-therapy',
  templateUrl: './form-regular-respiratory-therapy.component.html',
  styleUrls: ['./form-regular-respiratory-therapy.component.scss']
})
export class FormRegularRespiratoryTherapyComponent implements OnInit {
