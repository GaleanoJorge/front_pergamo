...
@Component({
  ...
  <div class="d-flex justify-content-center">
    ...
    <button nbTooltip="Certificado Médico" nbTooltipPlacement="top" nbTooltipStatus="primary" nbButton ghost (click)="viewCertificate()" >
...
export class ActionsCertificateComponent implements ViewCell {
  ...
  constructor(
    ...
    private certificateS: ChRecordService,
  ) {
  }
  ngOnInit() {
  ...
  viewCertificate() {
    this.certificateS.ViewCertificate(this.value.data.id).then(x => {
