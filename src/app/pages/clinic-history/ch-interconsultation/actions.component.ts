...
@Component({
  ...
  <div class="d-flex justify-content-center">
    ...
    <button nbTooltip="Orden Medica Interconsulta" nbTooltipPlacement="top" nbTooltipStatus="primary" nbButton ghost (click)="viewInterconsultation()" >
...
export class ActionsInterconsultationComponent implements ViewCell {
  ...
  constructor(
    ...
    private interconsultationS: ChRecordService,
  ) {
  }
  ngOnInit() {
  ...
  viewInterconsultation() {
    this.interconsultationS.ViewInterconsultation(this.value.data.id).then(x => {
