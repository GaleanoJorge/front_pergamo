...
@Component({
  ...
  <div class="d-flex justify-content-center">
    ...
    <button *ngIf="value.data.ch_sw_network_id == 5" nbTooltip="Certificado Abandono Social" nbTooltipPlacement="top" nbTooltipStatus="primary" nbButton ghost (click)="viewCertification()" >
...
export class ActionsSWComponent implements ViewCell {
  ...
  constructor(
    ...
    private viewCertificationS: ChRecordService,
