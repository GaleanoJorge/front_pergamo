...
@Component({
  selector: 'ngx-form-reason-consultation-social-work',
  templateUrl: './form-reason-consultation-social-work.component.html',
  styleUrls: ['./form-reason-consultation-social-work.component.scss']
})
export class FormReasonConsultationSocialWorkComponent implements OnInit {
