...
@Component({
  selector: 'ngx-form-social-work',
  templateUrl: './form-social-work.component.html',
  styleUrls: ['./form-social-work.component.scss']
})
export class FormSocialWorkComponent implements OnInit {
