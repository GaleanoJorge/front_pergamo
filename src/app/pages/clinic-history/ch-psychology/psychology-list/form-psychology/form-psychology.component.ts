...
@Component({
  selector: 'ngx-form-psychology',
  templateUrl: './form-psychology.component.html',
  styleUrls: ['./form-psychology.component.scss']
})
export class FormPsychologyComponent implements OnInit {
