...
import { FormPsychologyComponent } from './form-psychology/form-psychology.component';

@Component({
  selector: 'ngx-psychology-list',
...
export class PsychologyListComponent implements OnInit {
  ...
  NewAdmissions() {
    this.dialogFormService.open(FormPsychologyComponent, {
      context: {
