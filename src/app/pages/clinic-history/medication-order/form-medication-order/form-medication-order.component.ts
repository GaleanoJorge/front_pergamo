...
@Component({
  selector: 'ngx-form-medication-order',
  templateUrl: './form-medication-order.component.html',
  styleUrls: ['./form-medication-order.component.scss'],
})
export class FormMedicationOrderComponent implements OnInit {
  @Input() title: string;
  @Input() data: any = null;
  @Input() user: any = null;
