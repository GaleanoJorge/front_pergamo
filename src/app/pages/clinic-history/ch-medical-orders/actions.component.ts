...
@Component({
  ...
  <div class="d-flex justify-content-center">
    ...
    <button *ngIf = "this.rowData.ch_record_id == this.value.record_id" nbTooltip="Eliminar" nbTooltipPlacement="top" nbTooltipStatus="primary" nbButton ghost (click)="value.delete(value.data)">
...
export class ActionsMedicalOrderComponent implements ViewCell {
  ...
  constructor(
    ...
    private viewMedicalOrderS: ChRecordService,
  ) {
  }
  ngOnInit() {
  ...
  viewMedicalOrder() {
    this.viewMedicalOrderS.ViewMedicalOrder(this.value.data.id).then(x => {
