...
@Component({
  ...
  <div class="d-flex justify-content-center">
    ...
    <div *ngIf="value.data.laboratory_status_id == 4" class = "cuadro" 
     ...
     nbTooltip={{tooltip4}} nbTooltipPlacement="top" nbTooltipStatus="primary">
    </div>
    <div *ngIf="value.data.laboratory_status_id == 5" class = "cuadro" 
     [style]="'background-color: '+this.color5+';'"
     nbTooltip={{tooltip5}} nbTooltipPlacement="top" nbTooltipStatus="primary">
    </div>
    <div *ngIf="value.data.laboratory_status_id == 6" class = "cuadro" 
     [style]="'background-color: '+this.color6+';'"
     nbTooltip={{tooltip6}} nbTooltipPlacement="top" nbTooltipStatus="primary">
    </div>
  </div>
  `,
...
export class ActionsSemaphoreComponent implements ViewCell {
  ...
  public tooltip4: string;
  public tooltip5: string;
  public tooltip6: string;
  public today;
  public status;
  public description;
  ...
  async ngOnInit() {
    ...
    this.tooltip4 = 'Laboratorio recibido';

    this.color5 = this.colors.verde;
    this.tooltip5 = 'Laboratorio interpretado';

    this.color6 = this.colors.rojo;
    this.tooltip6 = 'Laboratorio cancelado';
