...
@Component({
  ...
  templateUrl: './prod-billing-package.component.html',
  styleUrls: ['./prod-billing-package.component.scss'],
})
export class ProdBillingPackageComponent implements OnInit {
  ...
  public settings_supplies = {
    columns: {
      select: {
        ...
        renderComponent: SelectProductBillingComponent,
      },
      name: {
