...
export class ProgramComponent implements OnInit {
    ...
    columns: {
      actions: {
        ...
        valuePrepareFunction: (value, row) => {
          ...
          return {
            'data': row,
            'edit': this.EditProgram.bind(this),
  ...
  NewProgram() {
    this.dialogFormService.open(FormProgramComponent, {
      context: {
  ...
  DeleteProgram(data) {
    return this.ProgramS.Delete(data.id).then(x => {
      this.table.refresh();
