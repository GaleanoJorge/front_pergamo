...
@Component({
  selector: 'ngx-form-pharmacy-bulk-inventory',
  templateUrl: './form-pharmacy-bulk-inventory.component.html',
  styleUrls: ['./form-pharmacy-bulk-inventory.component.scss'],
})
export class FormPharmacyBulkInventoryComponent implements OnInit {
  @Input() title: string;
  @Input() data: any = null;
