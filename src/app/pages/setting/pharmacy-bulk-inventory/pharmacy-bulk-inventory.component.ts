...
import { FormPharmacyBulkInventoryComponent } from './form-pharmacy-bulk-inventory/form-pharmacy-bulk-inventory.component';
import { ActionsSemaPharmaComponent } from './actions-semapharma.component';

@Component({
  selector: 'ngx-pharmacy-bulk-inventory',
  templateUrl: './pharmacy-bulk-inventory.component.html',
  styleUrls: ['./pharmacy-bulk-inventory.component.scss'],
})
export class PharmacyBulkInventoryComponent implements OnInit {
  ...
  public settings = {
    ...
    columns: {
      semaphore: {
        ...
        renderComponent: ActionsSemaPharmaComponent,
      },
      actions: {
        title: 'Acciones',
        type: 'custom',
  ...
  NewGloss() {
    this.dialogFormService.open(FormPharmacyBulkInventoryComponent, {
      context: {
