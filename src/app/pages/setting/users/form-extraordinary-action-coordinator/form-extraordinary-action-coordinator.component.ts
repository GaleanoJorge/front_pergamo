...
@Component({
  selector: 'ngx-form-extraordinary-action-coordinator',
  templateUrl: './form-extraordinary-action-coordinator.component.html',
  styleUrls: ['./form-extraordinary-action-coordinator.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class FormExtraordinaryActionCoordinatorComponent implements OnInit {
  @Input() title: string;
  @Input() data: any = null;
  ...
  save() {
    ...
    if (!this.form.invalid) {
      ...
      this.userRoleBS.Save({
        ...
        course_id: this.form.controls.course_id.value
      }, 'storeCoordinator').then(x => {
