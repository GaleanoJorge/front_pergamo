...
@Component({
  template: `
    <div class="d-flex justify-content-center">
      <button nbButton nbTooltip="Asociar procedimientos a manual tarifario" nbTooltipPlacement="top" nbTooltipStatus="primary"  ghost (click)="value.procedure(value.data)" >
        <nb-icon icon="file-outline"></nb-icon>
      </button>
      <button nbButton nbTooltip="Ver detalle de procedimientos asociados" nbTooltipPlacement="top" nbTooltipStatus="primary" ghost (click)="value.procedurelist(value.data)" >
