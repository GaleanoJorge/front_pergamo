...
@Component({
  selector: 'ngx-form-fixed-inventary-add',
  templateUrl: './form-fixed-inventary-add.component.html',
  styleUrls: ['./form-fixed-inventary-add.component.scss']
})
export class FormFixedInventaryAddComponent implements OnInit {
