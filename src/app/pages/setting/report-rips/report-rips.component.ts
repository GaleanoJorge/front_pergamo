...
import { FormReportRipsComponent } from './form-report-rips/form-report-rips.component';

@Component({
  selector: 'ngx-report-rips',
  templateUrl: './report-rips.component.html',
  styleUrls: ['./report-rips.component.scss']
})
export class ReportRipsComponent implements OnInit {
  ...
  NewPharmacy() {
    this.dialogFormService.open(FormReportRipsComponent, {
      context: {
