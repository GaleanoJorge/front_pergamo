...
@Component({
  selector: 'ngx-form-fixed-inventary-add-patients',
  templateUrl: './form-fixed-inventary-add-patients.component.html',
  styleUrls: ['./form-fixed-inventary-add-patients.component.scss']
})
export class FormFixedInventaryAddPatientsComponent implements OnInit {
  ...
  constructor(
    ...
    private UserRoleBusinessS: UserRoleBusinessService,
