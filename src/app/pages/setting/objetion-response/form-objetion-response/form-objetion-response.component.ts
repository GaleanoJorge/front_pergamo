...
@Component({
  ...
  templateUrl: './form-objetion-response.component.html',
  styleUrls: ['./form-objetion-response.component.scss']
})
export class FormObjetionResponseComponent implements OnInit {
