...
@Component({
  selector: 'ngx-form-dependence',
  templateUrl: './form-dependence.component.html',
  styleUrls: ['./form-dependence.component.scss']
})
export class FormDependenceComponent implements OnInit {
