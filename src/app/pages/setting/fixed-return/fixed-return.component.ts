...
import { ActionsReturnSedComponent } from './actions-return.component';
...
export class FixedReturnComponent implements OnInit {
  ...
  public title: string = 'ACEPTAR DEVOLUCIONES DE ACTIVOS FIJOS';
  ...
  public settings = {
    ...
    columns: {
      actions: {
        ...
        renderComponent: ActionsReturnSedComponent,
      },
      id: {
