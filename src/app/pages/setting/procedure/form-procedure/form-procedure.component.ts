...
export class FormProcedureComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    this.form = this.formBuilder.group({
      ...
      equivalent: [
        this.data.equivalent,
        Validators.compose([Validators.required]),
      ],
      name: [this.data.name, Validators.compose([Validators.required])],
      procedure_category_id: [
        this.data.procedure_category_id,
        Validators.compose([Validators.required]),
      ],
      pbs_type_id: [
        this.data.pbs_type_id,
        Validators.compose([Validators.required]),
      ],
      procedure_age_id: [
        this.data.procedure_age_id,
        Validators.compose([Validators.required]),
      ],
      gender_id: [
        this.data.gender_id,
      ...
      procedure_purpose_id: [
        this.data.procedure_purpose_id,
        Validators.compose([Validators.required]),
      ],
      purpose_service_id: [
        this.data.purpose_service_id,
        Validators.compose([Validators.required]),
      ],
      procedure_type_id: [
