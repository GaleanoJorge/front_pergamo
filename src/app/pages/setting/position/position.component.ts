...
export class PositionComponent implements OnInit {
    ...
    columns: {
      actions: {
        ...
        valuePrepareFunction: (value, row) => {
          ...
          return {
            'data': row,
            'edit': this.EditPosition.bind(this),
            'delete': this.DeleteConfirmPosition.bind(this),
          };
        },
  ...
  NewPosition() {
    this.dialogFormService.open(FormPositionComponent, {
      context: {
  ...
  ChangeState(data) {
    ...
    this.positionS.Update(data).then((x) => {
  ...
  DeleteConfirmPosition(data) {
    this.deleteConfirmService.open(ConfirmDialogComponent, {
      context: {
        name: data.name,
        data: data,
        delete: this.DeletePosition.bind(this),
      },
    });
  }

  DeletePosition(data) {
    return this.positionS.Delete(data.id).then(x => {
      this.table.refresh();
