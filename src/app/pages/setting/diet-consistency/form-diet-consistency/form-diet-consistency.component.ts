...
@Component({
  selector: 'ngx-form-diet-consistency',
  templateUrl: './form-diet-consistency.component.html',
  styleUrls: ['./form-diet-consistency.component.scss']
})
