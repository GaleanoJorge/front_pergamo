...
@Component({
  selector: 'ngx-form-specialtym',
  templateUrl: './form-specialtym.component.html',
  styleUrls: ['./form-specialtym.component.scss']
})
export class FormSpecialtymComponent implements OnInit {
