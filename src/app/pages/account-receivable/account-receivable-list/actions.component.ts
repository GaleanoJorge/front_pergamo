...
@Component({
    ...
    <div class="d-flex justify-content-center">
        <button
            *ngIf="!value.group && ((value.data.edit_date == 1 && !value.data.file_payment && value.role.role_type_id == 2) && !(value.data.status_bill_id == 3 || value.data.status_bill_id == 4))"
        ...
        <div
            *ngIf="!value.group && ((value.data.gross_value_activities > 5000000 && value.data.has_retention == 0 && value.role.role_type_id == 2) && !(value.data.status_bill_id == 3 || value.data.status_bill_id == 4))">
