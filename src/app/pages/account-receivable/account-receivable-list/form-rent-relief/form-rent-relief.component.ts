    ...
    if (!this.form.invalid) {
      ...
      if (this.procedence == 0) {
        ...
        this.AccountReceivableS.Update({
          ...
          gross_value_activities: this.source_retention.gross_value_activities,
          source_retention: this.source_retention.Retencion_por_aplicar,
          ica_retention: this.source_retention.Rete_ica,
          net_value_activities: this.source_retention.gross_value_activities - (this.source_retention.Retencion_por_aplicar + this.source_retention.Rete_ica),
