...
export class FormContractComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //   value_civil_policy: [this.data.value_civil_policy,
    //     //  Validators.compose([Validators.required])
    // ],
    //   start_date_civil_policy: [this.data.start_date_civil_policy, 
    //     // Validators.compose([Validators.required])
    // ],
    ...
    //   start_date_contractual_policy: [this.data.start_date_contractual_policy, 
    //     // Validators.compose([Validators.required])
    // ],
    //   finish_date_contractual_policy: [this.data.finish_date_contractual_policy, 
    //     // Validators.compose([Validators.required])
    // ],
    //   contractual_policy_insurance_id: [this.data.contractual_policy_insurance_id,
    //     // Validators.compose([Validators.required])
    // ],
